    ...
    <div className='bg-blue-950 h-screen w-screen flex flex-col items-center justify-center'>
      <div className='text-white bg-blue-800 w-2/5 rounded-lg px-12 py-8 border-2 border-white'>
        ...
        <form onSubmit={
          ...
          currencyArray={currenciesList}
          onCurrencyChange={(currency) => setFrom(currency)}
          selectCurrency={from}
          defaultCurrency='usd'
          />
            <button className='border-2 border-blue-white text-white bg-blue-950 rounded-full px-2 py-2 absolute left-1/2 -translate-x-1/2 -translate-y-1/2 '
            onClick={()=>{swapHandler()}}>
              <svg width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#191919"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M8 3.5L8 16.5M8 3.5L3.5 7.83333M8 3.5L12.5 7.83333" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M17 20.5L17 7.5M17 20.5L21.5 16.1667M17 20.5L12.5 16.1667" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
            </button>
          <InputBox 
          label='to'
          ...
          <button type='submit'
          className='border-2 border-white bg-blue-950 rounded-lg w-full py-4 text-lg'>Convert</button>
        </form>
